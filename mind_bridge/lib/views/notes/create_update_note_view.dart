...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView>
  ...
  void _textControllerListner() async {
    ...
    await _notesSerivce.updateNote(documentId: note.documentId, text: text);
  }
      ...
      children: [
        ...
        Positioned(
          ...
          child: Stack(
            ...
            children: [
              Image(image: image!.image, height: 35, width: 35),
              Positioned(
                top: 10,
                child: SvgPicture.asset('assets/icon/vhat.svg', height: 16),
              ),
            ],
          ),
        ),
